...
--ảnh 1--
Update Book
set Published=CAST(N'2023-09-25T00:00:00' AS SmallDateTime)
where Title= N'Giáo trình Tin học cơ bản1';
...
Update Book
set Title= N'Nếu như yêu'
where Images=N'1.png';
--ảnh 2--
Update Book
set Published=CAST(N'2023-09-24T00:00:00' AS SmallDateTime)
where Title= N'Giáo trình Tin học văn phòng';
...
Update Book
set Title= N'Yêu trên từng ngón tay'
where Images=N'2.png';

--ảnh 3--
Update Book
set Published=CAST(N'2023-09-23T00:00:00' AS SmallDateTime)
where Title= N'Lập Trình Cơ Sở Dữ Liệu Với Visual Basic 2005 Và ADO.NET 2.0';
...
Update Book
set Title= N'Lấp lánh'
where Images=N'7.png';

--ảnh 4--
Update Book
set Published=CAST(N'2023-09-22T00:00:00' AS SmallDateTime)
where Title=N'Visual Basic 2005 Tập 3, Quyển 2: Lập Trình Web';
...
Update Book
set Title=N'Thời gian tươi đẹp'
where Images=N'4.png';

--ảnh 5--
Update Book
set Published=CAST(N'2023-09-21T00:00:00' AS SmallDateTime)
where Title= N'Giáo trình Tin học quản lý 1';
...
Update Book
set Title= N'Vì em gặp anh'
where Images=N'5.png';

--ảnh 6--
Update Book
set Published=CAST(N'2023-09-20T00:00:00' AS SmallDateTime)
where Title=N'Giáo trình Tin học quản lý 2';
...
Update Book
set Title=N'Nếu anh là truyền thuyết của em'
where Images=N'6.png';

insert into Category(CategoryName) values (N'Luật') 

insert into Category(CategoryName) values (N'Lịch sử, địa lý') 
insert into Category(CategoryName) values (N'Kinh tế') 
insert into Category(CategoryName) values (N'Sách giáo khoa') 
insert into Category(CategoryName) values (N'Nghệ thuật sống') 


ALTER TABLE Book
ADD NhaXuatBanID int;


create table NhaXuatBan(
 NhaXuatBanID int identity(1,1) primary key,
 ...
 ALTER TABLE Book
ADD CONSTRAINT fk_Nhaxuatbanid Foreign key (NhaXuatBanID) references NhaXuatBan(NhaXuatBanID)



 insert into NhaXuatBan(NhaXuatBanName) values (N'Nhà xuất bản Trẻ')

  insert into NhaXuatBan(NhaXuatBanName) values (N'NXB Thống kê')
 insert into NhaXuatBan(NhaXuatBanName) values (N'Kim Đồng')
 insert into NhaXuatBan(NhaXuatBanName) values (N'Đại học Quốc Gia')
 insert into NhaXuatBan(NhaXuatBanName) values (N'Văn hóa nghệ thuật')
 insert into NhaXuatBan(NhaXuatBanName) values (N'Văn hóa')
 insert into NhaXuatBan(NhaXuatBanName) values (N'Lao động - xã hội')
 insert into NhaXuatBan(NhaXuatBanName) values (N'Khoa học & Ký Thuật')
